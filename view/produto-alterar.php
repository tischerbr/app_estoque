...
if ($_POST){
    ...
    !empty($_POST['validade']) ?  $p2->setValidade(\App\Helper\Moeda::set($_POST['validade'] ))  :  $p2->setValidade(null) ;
       $p2DAO = new \App\DAO\ProdutoDAO();
    if ($p2DAO->alterar($p2))    header("Location: produto-pesquisar.php?msg=2");
...
?>
    ...
    <form action="produto-alterar.php" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" id="valor" name="valor" class="form-control" value="<?php echo $resultado['valor'];?>">
        </div>
        <div class="form-group">
